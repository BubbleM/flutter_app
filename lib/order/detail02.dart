      ...
      slivers: <Widget>[
        SliverAppBar(
          ...
          flexibleSpace: FlexibleSpaceBar(
            ...
            background: Image.network(
                'https://img.58cdn.com.cn/escstatic/fecar/pmuse/youxinpai/orderbg.png',
                fit: BoxFit.cover),
          ),
        ),
        ...
        SliverToBoxAdapter(
          child: Container(
            ...
            child: Column(
              children: <Widget>[
                InfoCard(type: 'card', title: '订单金额', data: [
                  InfoItem('支付方式', '线下支付'),
                  InfoItem('车款', '82,000元'),
                  InfoItem('成交服务费', '-400元'),
                  InfoItem('实收款', '81,600元'),
                  InfoItem('保证金', '冻结出售保证金1000元，从抵押保证金中扣除，交易成功后会自动返回')
                ]),
                InfoCard(type: 'card', title: '交付信息', data: [
                  InfoItem('交割方', '优信拍代理'),
                  InfoItem('联系人', '优信拍代理·1010-1088'),
                  InfoItem('所在地', '北京')
                ]),
                InfoCard(type: 'card', title: '交付信息', data: [
                  InfoItem('交割方', '优信拍代理'),
                ...
                Container(
                  ...
                  child: InfoCard(type: 'card', title: '交付信息', data: [
                    InfoItem('交割方', '优信拍代理'),
                    InfoItem('联系人', '优信拍代理·1010-1088'),
                    InfoItem('所在地', '北京')
                  ]),
